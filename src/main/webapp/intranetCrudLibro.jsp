...
<body>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input class="form-control" id="id_reg_titulo"
														name="titulo" placeholder="Ingrese el Titulo" type="text"
														maxlength="100" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_reg_año">Año</label>
												<div class="col-lg-8">
													<input class="form-control" id="id_reg_año" name="anio"
														placeholder="Ingrese el Año" type="text" maxlength="8" />
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input class="form-control" id="id_reg_serie" name="serie"
														placeholder="Ingrese Serie" type="text" maxlength="8" />
												</div>
											</div>
											<div class="form-group">
												<label class="col-lg-3 control-label" for="id_reg_categoria">Categoría</label>
												<div class="col-lg-8">
													<select class="form-control" id="id_reg_categoria"
														name="categoria">
			...
			<div class="modal-dialog" style="width: 60%">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4>
							<span class="glyphicon glyphicon-ok-sign"></span> Actualización de
							Libro
						</h4>
					</div>
					<div class="modal-body">
									...
									<form id="id_form_actualiza">
										...
										<div class="panel-body">
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input class="form-control" id="id_act_anio" name="anio"
														placeholder="Ingrese el Año" type="text" maxlength="8" />
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<select class="form-control" id="id_act_categoria"
														name="categoria">
														<option value=" ">[Seleccione]</option>
													</select>
												</div>
	...
	<script type="text/javascript">
		...
		function verFormularioActualiza(idLibro, titulo, anio, serie, estado,
				categoria) {
													...
													titulo : {
														...
														validators : {
															...
															stringLength : {
																min : 3,
																max : 40,
																message : 'El título tiene de 3 a 40 caracteres'
															},
														}
													},
													anio : {
														...
														validators : {
															...
															regexp : {
																regexp : /^(\d{4}|\d{6})$/,
																message : 'El año tiene 4 dígitos'
															},
														}
													},
													serie : {
														...
														validators : {
															...
															stringLength : {
																min : 3,
																max : 15,
																message : 'La serie tiene de 3 a 15 caracteres'
															},
														}
													},
													categoria : {
