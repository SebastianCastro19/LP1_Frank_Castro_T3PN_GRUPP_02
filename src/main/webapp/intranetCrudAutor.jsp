...
<body>
	...
	//Funcion para cargar el comboBox Grado (Funcionando Perfectamente)
	...
	//Validaciones para la caja de texto registrar (funcionando Perfectamente)
		        	...
		        	nombre : {  
		        		...
		        		validators : {
		                    ...
		                    stringLength: {
		                        min: 3,
		                        max: 35,
		                        message: 'El nombre tiene de 3 a 35 caracteres'
		                    },
		        		}
		        	},
		        	apellido: {  
		        		...
		        		validators : {
		                    ...
		                    stringLength: {
		                        min: 3,
		                        max: 35,
		                        message: 'El apellido tiene de 3 a 35 caracteres'
		                    },
		        		}
		        	},
		        	fechaNacimiento : {
		        	...
		        	telefono: {  
		        		...
		        		validators : {
		                    ...
		                    stringLength: {
		                        min: 9,
		                        max: 9,
		                        message: 'El telefono debe tener 9 numeros'
		                    },
		        		}
		        	},
		        	grado : {
	...
	//Validaciones para la caja de texto ACTUALIZAR (Funciona Perfectamente) 
	$(document).ready(function() {
	...
	//Funcion para que registre autor (funcionando perfectamente)
	$("#id_btn_registra").click(function(){
		...
		//Funcion para mostrar datos (Funcionando Perfectamente)
		...
		//Agregar grilla (Funcionando Perfectamente)
		function agregarGrilla(lista){
			 ...
			 $('#id_table').DataTable({
					...
					columns:[  
						...
						{data: function(row, type, val, meta){
							return '<button type="button" class="btn btn-warning btn-sm" onClick="eliminacionLogica(\'' + row.idAutor + '\');" >E.Logica</button>';
						},className:'text-center'},
						{data: function(row, type, val, meta){
							return '<button type="button" class="btn btn-danger btn-sm"  onClick="eliminacionFisica(\'' + row.idAutor +'\');" >E.Fisica</button>';
						},className:'text-center'},
					]                                     
			    });
		}
		...
		function verFormularioActualiza(idAutor, nombre, apellido, fecnac, telefono, estado, grado){
